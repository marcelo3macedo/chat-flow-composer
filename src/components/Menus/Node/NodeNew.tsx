...
export function NodeNew() {
    const { selected } = useModalStore();
    if (selected !== 'new-node') return <></>

    return (
        <div className="fixed left-0 top-0 inset-0 py-12 z-50 bg-black bg-opacity-50 flex items-center justify-center transition-opacity duration-300">
